...
class DeveloperLayoutSP(DeveloperLayout):
  ...
  def _initialize_items(self):
    self.show_advanced_controls = toggle_item_sp(tr("Show Advanced Controls"),
                                                 tr("Toggle visibility of advanced ORBIT controls.<br>This only changes the visibility of the toggles; " +
    ...
    self.error_log_btn = button_item(tr("Error Log"), tr("VIEW"), tr("View the error log for ORBIT crashes."), callback=self._on_error_log_clicked)
