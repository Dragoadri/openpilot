...
class SteeringLayout(Widget):
  ...
  def _initialize_items(self):
    self._mads_base_desc = tr("Enable the beloved MADS feature. " +
                              "Disable toggle to revert back to stock ORBIT engagement/disengagement.")
    ...
    self._torque_control_toggle = toggle_item_sp(
      ...
      description=lambda: tr("Enable this to enforce ORBIT to steer with Torque lateral control."),
    )
