...
class SelfdriveD(CruiseHelper):
  def __init__(self, CP=None, CP_SP=None):
    ...
    is_remote = build_metadata.openpilot.comma_remote or build_metadata.openpilot.sunnypilot_remote or build_metadata.openpilot.orbit_remote
  ...
  def update_events(self, CS):
    ...
    if self.sm['modelV2'].meta.laneChangeState == LaneChangeState.preLaneChange:
      ...
      if (CS.leftBlindspot and direction == LaneChangeDirection.left) or \
        ...
        # [Orbit] evento direccional de ángulo muerto en cambio de carril (param c_carril)
        try:
