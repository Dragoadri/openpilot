...
class Setup(Widget):
  def __init__(self):
    ...
    self._custom_software_warning_body_label = Label("Use caution when installing third-party software.\n\n"
                                                     + "WARNING: It has not been tested by comma.\n\n"
                                                     + "WARNING: It may not comply with relevant safety standards.\n\n"
                                                     + "WARNING: It may cause damage to your device and/or vehicle.\n\n"
