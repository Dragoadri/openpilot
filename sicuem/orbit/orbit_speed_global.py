...
# -*- coding: utf-8 -*-
"""
Sistema de Control de Velocidad Orbit - Enfoque con Variables Globales
...
class OrbitSpeedGlobal:
  ...
  def process_speed_commands(self, car_control, car_state, v_cruise_helper):
    ...
    if orbit_speed_increase or orbit_speed_decrease:
...
orbit_speed_global = OrbitSpeedGlobal()
